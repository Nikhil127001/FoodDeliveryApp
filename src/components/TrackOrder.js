...
import Homeheadnavbar from './Homeheadnavbar'
import BottomNav from './BottomNavbar'
import { colors } from '../globals/screens/global/style'
    ...
    return (
        <View style={styles.container}>
            ...
            <ScrollView style={styles.containerin}>
                ...
                <View>
                    {orders.sort(
                        (a, b) => b.orderData.seconds - a.orderData.seconds
                    ).map((order, index) => {
                        return (
                            <View style={styles.order} key={index}>
                                ...
                                <View style={styles.row1}>
                                    ...
                                    {
                                        order.deliveryboy_name ? <Text style={styles.ordertxtn}>{order.deliveryboy_name} : {order.deliveryboy_contact}</Text> : <Text style={styles.ordertxtn}>Not Assigned</Text>
                                    }
                                    {
                                        order.deliveryboy_phone ? <Text style={styles.ordertxtn}>{order.deliveryboy_phone}</Text> : null
                                    }
                                </View>
